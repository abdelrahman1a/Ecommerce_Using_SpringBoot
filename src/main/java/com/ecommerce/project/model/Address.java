...
public class Address {
    ...
    @NotBlank
    @Size(min = 5, message = "StreetName Must be at least 5 characters")
    ...
    public Address(Long addressId, String street, String buildingName, String city, String state, String country, Integer pincode) {
